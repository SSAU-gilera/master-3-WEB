...
- Изучить [RxJS Pipe Operators](https://rxjs.dev/guide/operators) которые встречались в лекции (scan, take, finalize и т.д.) 
- Изучить [RxJS Multicast Operators](https://habr.com/ru/post/490988/) 

Список источников
- [Современный учебник JavaScript](https://learn.javascript.ru)
- [www.w3schools.com](https://www.w3schools.com/js/default.asp)
- [rxjs-dev](https://rxjs-dev.firebaseapp.com)
- [Wikipedia - Реактивное_программирование](https://ru.wikipedia.org/wiki/Реактивное_программирование)
- [Хабр - Введение в реактивное программирование](https://habr.com/ru/company/arcadia/blog/432004)
- [RxJs API](https://rxjs.dev/api)
- [AJAX Guide](https://developer.mozilla.org/ru/docs/Web/Guide/AJAX)
...
Самостоятельно изучить работу
- Изучить [TS Handbook](https://www.typescriptlang.org/docs/handbook/intro.html)
- Изучить [Utility Types](https://www.typescriptlang.org/docs/handbook/utility-types.html)

Список источников
- [Официальная документация](https://www.typescriptlang.org/) 
- [Tutorial на русском языке](https://metanit.com/web/typescript/) 
- [Подробнее про декораторы](https://habr.com/ru/company/ivi/blog/275003/)
